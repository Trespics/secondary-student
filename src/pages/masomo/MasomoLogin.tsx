...
const MasomoLogin = () => {
  ...
  const redirectParams = searchParams.get("redirect") || "/masomo";
    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f172a 0%, #1e1b4b 50%, #0f172a 100%)", display: "flex", alignItems: "center", justifyContent: "center", padding: "1.5rem" }}>
      ...
      >
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <h1 style={{ fontSize: "1.75rem", fontWeight: 700, color: "#f1f5f9", marginBottom: "0.5rem" }}>Masomo Portal</h1>
