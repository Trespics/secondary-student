        ...
        <div className="footer-grid">
          ...
          <div className="footer-section brand-section">
            ...
            <p className="footer-description">
              Empowering students with modern tools for better learning outcomes. 
          ...
          <div className="footer-section">
            ...
            <ul className="footer-links">
              ...
              <li><a href="/student"><span className="link-arrow">→</span> Student Portal</a></li>
              <li><a href="/masomo"><span className="link-arrow">→</span> Masomo Portal</a></li>
            </ul>
          </div>
